var a="Assignment 4: Employee Monthly Salary (Based on Working Days)";
console.log(a);
function Employee(name, salary, designation, workingDays, month) {
    ...
    this.month = month;
    var b="Method to calculate monthly salary based on working days";
    console.log(b);
...
var emp1 = new Employee("nani", 1200000, "Software Engineer", 20, "Jun");
